...
class EnergyMonitor
{
  ...
  private:
    ...
    double filteredI,filteredI2;
    double offsetV;                          //Low-pass filter output
    double offsetI,offsetI2;                          //Low-pass filter output

    double phaseShiftedV;                             //Holds the calibrated phase shifted voltage.

    double sqV,sumV,sqI,sumI,sqI2,sumI2,instP,sumP;              //sq = squared, sum = Sum, inst = instantaneous
